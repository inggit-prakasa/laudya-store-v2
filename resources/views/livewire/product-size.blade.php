                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group form-show-validation row">
                            <label for="name" class="col-lg-2 mt-sm-2 text-left">Nama Ukuran</label>
                            <div class="col-lg-4 col-md-9 col-sm-8">
                                <input wire:model="name" type="text" class="form-control" id="name" name="name" placeholder="Masukan ukuran" required>
                            </div>
